...
\vspace{2cm}
\vfill
\begin{minipage}{7cm} % modify this width in order to keep everything on the same line
\Large{Candidates:\\
...
\appendix
\input{appendices/usermanual2.tex}
\input{appendices/usermanual1.tex}
